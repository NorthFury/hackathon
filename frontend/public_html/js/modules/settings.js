define({
    ...
    getGoogleOpenIdLink: function() {
        ...
        var webAppDomain = "http://localhost:8383/doit/login.html";
        return baseUrl + '&openid.ns.max_auth_age=' + this.authenticationAge + '&openid.return_to=' + webAppDomain + '&openid.realm=' + webAppDomain;
    }
});
